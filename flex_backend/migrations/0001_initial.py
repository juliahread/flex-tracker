# Generated by Django 2.1.2 on 2018-11-11 20:18

from django.conf import settings
import django.contrib.postgres.fields.jsonb
from django.db import migrations, models
import django.db.models.deletion
import flex_backend.models
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service_provider', models.CharField(choices=[('Alltel', 'message.alltel.com'), ('AT&T', 'txt.att.net'), ('Boost Mobile', 'myboostmobile.com'), ('Cricket Wireless', 'sms.cricketwireless.net'), ('Project Fi', 'msg.fi.google.com'), ('Sprint', 'messaging.sprintpcs.com'), ('U.S. Cellular', 'tmomail.net'), ('Verizon', 'email.uscc.net'), ('Virgin Mobile', 'vtext.com'), ('Republic Wireless', 'text.republicwireless.com'), ('UNKNOWN', 'UNKNOWN')], default='UNKNOWN', max_length=50)),
                ('preferences', django.contrib.postgres.fields.jsonb.JSONField(default=flex_backend.models.flex_info.default_preferences)),
